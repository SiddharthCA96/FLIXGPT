  ...
  return (
    <div className="pt-36 px-10">
      ...
      <div className="mt-4 flex space-x-2">
        {/* Play Button */}
        <button
          className="flex items-center justify-center w-32 h-12 bg-white text-black rounded-lg shadow-lg hover:bg-gray-200 focus:outline-none"
        >
        ...
        {/* More Info Button */}
        <button
          className="flex items-center justify-center w-32 h-12 bg-gray-500 text-white rounded-lg shadow-lg hover:bg-black focus:outline-none"
        >
          <svg
